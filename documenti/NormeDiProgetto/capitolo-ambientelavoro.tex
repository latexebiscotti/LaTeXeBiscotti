...
\item \textbf{Gestione dei bug}: il controllo \glossario{bug} aiuta a inviare, controllare e correggere i \glossario{bug} e le problematiche che possono incorrere nello sviluppo del progetto. 
