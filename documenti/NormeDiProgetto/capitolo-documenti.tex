...
Per rendere più facile la stesura dei vari documenti sono stati realizzati una serie di template \LaTeX{} contenenti tutte le impostazioni stilistiche, di layout, tutte i comandi definiti da utente e le impostazioni locali riguardanti ciascun file. I file di impostazioni “globali” sono reperibili nel \glossario{repository} \texttt{LaTeXeBiscotti/modello}, e sono titolati \texttt{global.tex} e \texttt{layout.tex}; i file di impostazioni “locali” sono denominati \texttt{local.tex} e sono presenti in ogni \glossario{repository} dei vari documenti redatti.
