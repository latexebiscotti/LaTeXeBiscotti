...
\newcommand{\ScopoDelProdotto}{
	Lo scopo del progetto è la realizzazione di un \glossario{algoritmo predittivo} in ambiente \glossario{Internet of Things} in grado di analizzare i dati provenienti da “oggetti”, inseriti in diversi contesti, e fornire delle previsioni su possibili guasti, interazioni con nuovi utenti ed identificare dei pattern di comportamento degli utenti per prevedere le azioni degli stessi su altri oggetti o altri contesti. 
}
...
\newcommand{\makeFrontPage}{
  ...
  \begin{center}
  \includegraphics[width=8cm]{../../modello/cookie.png}
  \end{center}
